...
struct Z_Construct_UClass_AFPS_Character_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OurMovementComponent_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "FPS/FPS_Character.h" },
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFPS_Character_Statics::NewProp_OurMovementComponent = { "OurMovementComponent", nullptr, (EPropertyFlags)0x0040000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFPS_Character, OurMovementComponent), Z_Construct_UClass_UUFPS_CharacterMovementComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OurMovementComponent_MetaData), NewProp_OurMovementComponent_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFPS_Character_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFPS_Character_Statics::NewProp_OurMovementComponent,
...
struct Z_CompiledInDeferFile_FID_Repos_C_FPS_FPS_Project_Source_FPS_Project_FPS_FPS_Character_h__Script_FPS_Project_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFPS_Character, AFPS_Character::StaticClass, TEXT("AFPS_Character"), &Z_Registration_Info_UClass_AFPS_Character, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFPS_Character), 2295775998U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Repos_C_FPS_FPS_Project_Source_FPS_Project_FPS_FPS_Character_h__Script_FPS_Project_2137788611(TEXT("/Script/FPS_Project"),
